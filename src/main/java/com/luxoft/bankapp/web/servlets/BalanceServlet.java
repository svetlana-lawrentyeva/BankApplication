...
public class BalanceServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(client != null){
            try {
                balance = ServiceFactory.getAccountService().getClientBalance(client);
        ...
        out.println("Client "+clientName+" balance: "+balance);
        out.println("<a href='bankomat/menu.html'>go back...</a>");
    }
}
